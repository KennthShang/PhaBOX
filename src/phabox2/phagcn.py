...
def run(inputs):
    ...
    if inputs.task != 'end_to_end':
        _ = os.system(f"cp {rootpth}/filtered_contigs.fa {rootpth}/{out_dir}/phagcn_supplementary/all_predicted_contigs.fa")
        ...
        _ = os.system(f'sed -i "1i\qseqid\tsseqid\tpident\tlength\tmismatch\tgapopen\tqstart\tqend\tsstart\tsend\tevalue\tbitscore" {rootpth}/{out_dir}/phagcn_supplementary/alignment_results.tab')
